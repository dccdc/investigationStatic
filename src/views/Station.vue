	...
	<div  class="overflow-x-hidden">
		...
		<div v-if="stationData != null" class="text-center" style="margin-top: 55px; margin-bottom: 50px;">
				...
				<v-row class="content">
					...
					<monthAndYear v-if="typeof stationData.spanStatistic !== 'undefined'" :spanStatistic="stationData.spanStatistic"></monthAndYear>
				</v-row>
				...
				<v-row class="content">
					...
					<indicatorBar v-if="typeof stationData.indicatorAverageList !== 'undefined'" :chartData="stationData.indicatorAverageList"></indicatorBar>
				</v-row>
